...
.DATASET_KEY_OVERRIDES <- c(
  # ---- Old API list: append "Old" where keys would clash ------------------
  "pay_psa"          = "payPsaOld",
  "pay_prism"        = "payPrismOld",
  "wholesale_prices" = "wholesalePricesOld",
  "retail_prices"    = "retailPricesOld",
  "farmgate_prices"  = "farmgatePricesOld",
  "gdp"              = "gdpOld",
  "oil_price"        = "oilPriceOld",
  "seed_class"       = "seedClassOld",
  "soil_type"        = "soilTypeOld",
  "urea_use"         = "ureaUseOld",
  "us_cpi"           = "usCpiOld",
  "imports"          = "importsOld",
  # ---- Old API list: cleaner names (no clash) -----------------------------
  "exrates"          = "exRates",
  "beginning_stocks" = "beginningStocks",
  "ending_stocks"    = "endingStocks",
  "corn_price"       = "cornPrice",
  "cropestab"        = "cropEstabOld",
  "urea_price"       = "ureaPrice",
  "vfa_fob_prices"   = "vfaFobPrices",
  "fao_fob_prices"   = "faoFobPrices",
  "popn"             = "popn",
  "rice_area"        = "riceArea",
  "rice_consum"      = "riceConsum",
